...
to make use of their results} A final point of interest of this project is to
...
are selected for that language\markus{Well, not quite. We cannot easily use the
PLE stuff on language level. But we can define modular sets of constraints that
can or cannot be used in particular programs. Same effect, but different
approach.}.
